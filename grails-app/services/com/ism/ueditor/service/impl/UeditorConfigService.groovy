...
package com.ism.ueditor.service.impl
...
import ueditor.utils.Ueditor
import ueditor.utils.UeditorConfig
...
class UeditorConfigService implements InitializingBean {
    ...
    void afterPropertiesSet() throws Exception {
        ...
        // with this new version scheme, version 1.4.3_1 is a plugin patch to ueditor 1.4.3
        ...
        config = (JSONObject)JSON.parse(new ClassPathResource('/UeditorConfig.json').inputStream,"UTF8")
